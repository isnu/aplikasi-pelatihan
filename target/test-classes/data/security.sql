...
values('u001', 'isnu', 'password', true);

insert into s_users (id, username, password, active)
values('u002', 'guest', 'guest', true);
...
select username, password, active as enabled from s_users where username = 'isnu';
